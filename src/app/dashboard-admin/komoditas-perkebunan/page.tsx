        ...
        <div className="w-full space-y-6">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Komoditas Perkebunan</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Dashboard Komoditas Perkebunan</h1>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="dark">Holtikultura</SelectItem>
                  <SelectItem value="system">Perkebunan</SelectItem>
                </SelectContent>
              </Select>
              <Select>
                <SelectTrigger className="w-[180px]">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="light">Ngawi</SelectItem>
                  <SelectItem value="dark">Ngawi</SelectItem>
                  <SelectItem value="system">Ngawi</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
...
export default KomoditasPerkebunanPage;
