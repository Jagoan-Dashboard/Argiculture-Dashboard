...
import { HamaData } from './types/dominasi';
import { DominasiHamaSection } from './components/DominasiHamaSection';
import { TeknologiSection } from './components/TeknologiSection';
import { TeknologiData } from './types/teknologi';
        ...
        <div className="w-full space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Dashboard Komoditas Pangan</h1>
            </div>
            {/* Filters */}
            <div className="flex flex-col sm:flex-row gap-3">
              <Select>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Komoditas: Padi Sawah" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="light">Padi Sawah</SelectItem>
                  <SelectItem value="dark">Padi Ladang</SelectItem>
                  <SelectItem value="system">Ubi Kayu</SelectItem>
                  <SelectItem value="system">Ubi Jalar</SelectItem>
                  <SelectItem value="system">Kacang Tanah</SelectItem>
                  <SelectItem value="system">Jagung</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
...
export default KomoditasPanganPage;
