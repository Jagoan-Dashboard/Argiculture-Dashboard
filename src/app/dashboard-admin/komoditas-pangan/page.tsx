...
import { useFoodCrop } from './hooks/useFoodCrop';
...
const KomoditasPanganPage = () => {
  ...
  const proparsiData: GrowthPhaseData[] = useMemo(() => {
    ...
    return data.growth_phases.map((phase, index) => ({
      ...
      fullName: GROWTH_PHASE_MAP[phase.phase] || phase.phase
    }));
  }, [data]);
  ...
  const hamaData: HamaData[] = useMemo(() => {
    ...
    return data.pest_dominance.map((pest, index) => ({
      ...
      color: colors[index % colors.length],
      fullName: PEST_MAP[pest.pest_type] || pest.pest_type
    }));
  }, [data]);
        ...
        <div className="bg-gray-50 rounded-lg p-4 lg:p-6">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-gray-600">Memuat data komoditas pangan...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-4 lg:p-6">
        <div className="w-full space-y-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Select value={selectedCommodity} onValueChange={handleCommodityChange}>
                ...
                <SelectContent>
                  {FOOD_CROP_COMMODITY_OPTIONS.map((option) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <MapSection commodityMapData={mapData} title='Peta Persebaran Komoditas Pangan' />
